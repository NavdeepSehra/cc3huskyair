...
<ul>
  <li><a href="dashboard_odonar.php">Home</a></li>
  
<?php 
$id=$_SESSION['Unique_ID'];
$sql="SELECT * FROM organ_donar_user where unique_id='$id'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result)
?>
  <li><a href="profile_odonar.php?id=<?php echo $row['unique_id']; ?>">Profile</a></li>
  <li class="dropdown">
