...
$sql="SELECT * FROM admin_user where unique_id='$id'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result)
?>
  <li><a href="profile_admin.php?id=<?php echo $row['unique_id']; ?>">Profile</a></li>
  <li><a href="admin_create_user.php">Users</a></li>
  <li><a href="report_card.php">Flights Report</a></li>
  <li class="dropdown">
